            ...
            .execute(object : DialogCallback<LzyResponse<Student>>(this) {
                override fun onSuccess(response: Response<LzyResponse<Student>>) {
                    ...
                    if (medicalHistory != null) {
                        tvMedicalHistory.text = medicalHistory.joinToString(limit = 4)
                        medicalHistoryList = medicalHistory as MutableList<String>
                    }
                    ...
                    if (spine != null) {
                        ...
                        if ("无侧弯" == waistChest?.category) llYaoXiongDegree.visibility = View.INVISIBLE

                        val waist = spine.sideBend?.waist
                        tvXiong.text = waist?.category
                        tvXiongDegree.text = waist?.degree
                        ...
                        if ("无前后弯曲异常" == baBend?.category) llQianHouDegree.visibility = View.INVISIBLE
                    }
